...
if "official" in clusters_path:
   recall_path="recall_results_on_official_clusters_by_cluster_size/"+runtag+".txt"
elif "alternative" in clusters_path:
   recall_path="recall_results_on_alternative_clusters_by_cluster_size/"+runtag+".txt"
